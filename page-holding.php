            ...
            <div>
                <div>
                    <div>
                        ...
                        <a href="#register" class="updates">Stay Informed</a> &nbsp; 
                        <a href="#contribute" class="contribute">Get Involved</a>
                    </div>
                    <a href="#register" class="down"></a>
                </div>
            </div>
        </header>
        ...
        <section id="register">
            <div>
                <article>
                    ...
                    <h3>Follow the project on Twitter</h3>
                    <a href="https://twitter.com/opentrials" rel="external" class="twitter">@opentrials</a>
                    <hr>
